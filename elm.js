...
Elm.MarkdownEditor.make = function (_elm) {
   "use strict";
   _elm.MarkdownEditor = _elm.MarkdownEditor || {};
   if (_elm.MarkdownEditor.values) return _elm.MarkdownEditor.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var navStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                                 ,{ctor: "_Tuple2",_0: "width",_1: "100%"}
                                                 ,{ctor: "_Tuple2",_0: "height",_1: "55px"}
                                                 ,{ctor: "_Tuple2",_0: "display",_1: "flex"}
                                                 ,{ctor: "_Tuple2",_0: "flex-direction",_1: "row"}
                                                 ,{ctor: "_Tuple2",_0: "background-color",_1: "#1abc9c"}
                                                 ,{ctor: "_Tuple2",_0: "top",_1: "0"}
                                                 ,{ctor: "_Tuple2",_0: "left",_1: "0"}
                                                 ,{ctor: "_Tuple2",_0: "box-shadow",_1: "0px 2px 2px #34495e"}]));
   var view = function (model) {    return A2($Html.div,_U.list([navStyle]),_U.list([]));};
   var main = view({});
   return _elm.MarkdownEditor.values = {_op: _op,view: view,navStyle: navStyle,main: main};
};
